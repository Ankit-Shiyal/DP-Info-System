...
const baseDir = '/Applications/XAMPP/xamppfiles/htdocs/acriotech/src/app';
const compDir = '/Applications/XAMPP/xamppfiles/htdocs/acriotech/src/components';

// 1. Create LegalLayout Component
const legalLayoutCode = `
import React from 'react';
import NavBar from "./NavBar";
import Footer from "./Footer";

const links = [
  { group: 'Company', items: [{ name: 'Contact Us', path: '/contact-us' }] },
...
export default function LegalLayout({ children, activePath }) {
  return (
...
fs.writeFileSync(path.join(compDir, 'LegalLayout.tsx'), legalLayoutCode);
